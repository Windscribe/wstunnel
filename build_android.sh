...
TOOLCHAIN=("$ANDROID_NDK/toolchains/llvm/prebuilt/darwin-x86_64/bin/aarch64-linux-android21-clang")
...
TOOLCHAIN=("$ANDROID_NDK/toolchains/llvm/prebuilt/darwin-x86_64/bin/armv7a-linux-androideabi21-clang")
# shellcheck disable=SC2086
...
TOOLCHAIN=("$ANDROID_NDK/toolchains/llvm/prebuilt/darwin-x86_64/bin/i686-linux-android21-clang")
# shellcheck disable=SC2086
...
TOOLCHAIN=("$ANDROID_NDK/toolchains/llvm/prebuilt/darwin-x86_64/bin/x86_64-linux-android21-clang")
# shellcheck disable=SC2086
